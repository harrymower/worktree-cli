...
export function generateCompose(options: ComposeOptions): Record<string, unknown> {
...
export function writeComposeFile(filePath: string, compose: Record<string, unknown>): void {
